...
class TherapeuticMilestone(Enum):
    ...
    SOCIAL_RECONNECTION = "social_reconnection"  # ?
    EMOTIONAL_STABILITY = "emotional_stability"  # ?
    SELF_EFFICACY = "self_efficacy"             # 自動
    PEER_SUPPORT = "peer_support"               # ?
    MENTORSHIP = "mentorship"                   # メイン
    ...
    def _initialize_cosmetic_catalog(self):
        ...
        titles = [
            CosmeticItem(
                ...
                therapeutic_meaning="勇",
                visual_data={"text": "は", "color": "#4CAF50"}
            ),
            CosmeticItem(
            ...
            CosmeticItem(
                ...
                therapeutic_meaning="?",
                visual_data={"text": "コア", "color": "#9C27B0"}
            )
        ]
...
if __name__ == "__main__":
    ...
    print(f"エラー: {json.dumps(summary, indent=2, ensure_ascii=False)}")