...
class UnlockConditionType(Enum):
    ...
    TASK_COMPLETION = "task_completion"        # タスク
    STORY_BRANCH = "story_branch"              # ストーリー
    TIME_BASED = "time_based"                  # ?
    ACHIEVEMENT = "achievement"                # 実装
...
class StoryIntegration:
    """ストーリー"""
    job_unlock_story_node: str                 # ?
    job_change_dialogue: str                   # ?
    special_story_branches: List[str]          # ?
    character_development_arc: str             # ?
...
class AdvancedJobSystem:
    ...
    def generate_job_change_story(self, job_type: JobType, user_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "special_choices": [
                ...
                for branch in story_integration.special_story_branches[:3]  # ?3?
            ],
    ...
    def _generate_choice_text(self, branch_id: str) -> str:
        ...
        return choice_texts.get(branch_id, f"?: {branch_id}")
