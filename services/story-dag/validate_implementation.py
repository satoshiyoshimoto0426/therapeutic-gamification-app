...
def verify_imports():
    ...
    try:
        ...
        print("? Story DAG models imported successfully")
    except ImportError as e:
        print(f"? Failed to import story DAG models: {e}")
        return False
    ...
    try:
        ...
        print("? Story DAG functions imported successfully")
    except ImportError as e:
        print(f"? Failed to import story DAG functions: {e}")
        return False
...
async def verify_story_node_management():
    ...
    print("\n? Verifying story node management...")
...
async def verify_story_edge_management():
    ...
    print("? Story edge management with real-world task linking working correctly")
    return True

async def verify_dag_validation():
    """Verify DAG structure validation"""
    print("\n? Verifying DAG validation...")
    ...
    print("? DAG validation and cycle prevention working correctly")
    return True

async def verify_user_story_progression():
    """Verify user story state and progression"""
    print("\n? Verifying user story progression...")
    ...
    print("? User story progression with companion and ending tracking working correctly")
    return True

async def verify_companion_system():
    """Verify companion relationship system"""
    print("\n? Verifying companion system...")
    ...
    assert yu_companion.description == "あ"
    ...
    print("? Companion system working correctly")
    return True

async def verify_multi_ending_support():
    """Verify multi-ending story support"""
    print("\n? Verifying multi-ending support...")
    ...
    print("? Multi-ending story support working correctly")
    return True

async def verify_story_analytics():
    """Verify story analytics and insights"""
    print("\n? Verifying story analytics...")
    ...
    print("? Story analytics working correctly")
    return True

async def main():
    """Main validation function"""
    print("? Verifying Task 7: Create story DAG management system")
    print("=" * 80)
    ...
    if all_passed:
        ...
        print("? Task 7 has been successfully implemented with all sub-tasks:")
        print("   ? Story node and edge data structures with CHAPTER > NODE > EDGE hierarchy")
        print("   ? DAG validation to prevent cycles and ensure connectivity")
        print("   ? Story state tracking per user with unlock conditions")
        print("   ? Real-world task linking via real_task_id and habit_tag")
        print("   ? Story progression logic with branch probability calculations")
        print("   ? Companion relationship system for multi-character stories")
        print("   ? Multi-ending support with choice influence tracking")
        print("   ? Story analytics for popular paths and ending trends")
        print("   ? Unit tests for DAG operations and story state management")
        print("\n? Ready for enhanced gamification features integration!")
        return True
    else:
